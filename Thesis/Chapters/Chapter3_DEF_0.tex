...
In this section, similar as in ASR cases, simulation of DEF expansion on 10x10x10mm size model with only single aggregate in center of it is presented. As for the scale we considered here is relatively small, uniformed expansion is applied. 0.0003 initial strain is given to all paste interfaces uniformly in this simulation. 
