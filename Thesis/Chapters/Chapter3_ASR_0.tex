...
In this section, simulation of ASR expansion on a single aggregate case in size only 10x10x10mm is presented.
...
% Small ASR CR
  ...
  \centering
      ...
      \input{Chapters/tag_crack_s}

  \caption{Cross Section in Each Step for ASR 10x10x10mm Case (Deformation x 10)}
...
% Small ASR IS
  ...
  \caption{Internal Stress in Each Step for ASR 10x10x10mm Case (Deformation x 10)}
